    ...
    return (
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
            ...
            <p className="mt-4 text-base font-normal text-gray-500 sm:text-xl dark:text-gray-400">
                Hi my name is Alexandros Kaloudis and i am a Software Engineer. This app demonstrates my passion for problem solving in my daily life
            </p>
            </div>
            <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-extrabold leading-tight tracking-tight text-gray-900 sm:text-4xl dark:text-white">
            ...
            <p className="mt-4 text-base font-normal text-gray-500 sm:text-xl dark:text-gray-400">
                The app was built to give a solution to the problem of finding local tech events that may be interesting and having them all in one place. 
                In addition to that the user does not need to do anything besides navigating to the spots page and clicking on an event to find out more info about events.
            </p>
            </div>
